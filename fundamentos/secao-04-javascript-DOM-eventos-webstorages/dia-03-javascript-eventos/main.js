...
const alteraTextoTech = (evento) => {
  const techElement = document.querySelector(".tech");
  techElement.innerText = evento.target.value;
};

input.addEventListener("input", alteraTextoTech);
...
top3.addEventListener("dblclick", clickTwice);
...
top3.addEventListener("mouseout", unchangeColor);
